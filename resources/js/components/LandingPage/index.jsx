                        ...
                        <ol>
                            <li className="lead text-dark">
                                <p>
                                    ...
                                    Just click the chat button below.
                                </p>
                            </li>
                            <li className="lead">
                                <p>
                                    We’ll ask you a couple of basic questions to
                            ...
                            <li className="lead">
                                <p>
                                    Using the information you provide, we’ll
                                    immediately create a customized checklist to
                                    guide you through your next steps of
                                    planning.{' '}
                                    <span className="font-italic">
                                        Hint: it’s also a really great tool for
                ...
                <div className="row no-gutters py-4">
                    <div className="col">
                        ...
                        <p className="text-center text-dark">
                            Enter your email address below to stay in the loop
                            on content and updates.
                        </p>
